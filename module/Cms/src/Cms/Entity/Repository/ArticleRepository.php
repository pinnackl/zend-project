...
//               "WHERE b.status = 'OPEN' AND e.id = ?1 OR r.id = ?1 ORDER BY b.created DESC";
		$dql = "SELECT a, u, l, c, p, r FROM Cms\Entity\Article a LEFT JOIN a.author u LEFT JOIN a.language l LEFT JOIN a.categories c LEFT JOIN a.parent p LEFT JOIN a.resource r WHERE a.artcId = ?1";
