...
class CommentRepository extends EntityRepository
{
    ...
    {
//        $dql = "SELECT b, e, r, p FROM \Cms\Entity\User b JOIN b.engineer e ".
...
//               "WHERE b.status = 'OPEN' AND e.id = ?1 OR r.id = ?1 ORDER BY b.created DESC";
		$dql = "SELECT c, u, l, a FROM Cms\Entity\Comment c LEFT JOIN c.author u LEFT JOIN c.language l LEFT JOIN c.article a WHERE c.comId = ?1";
