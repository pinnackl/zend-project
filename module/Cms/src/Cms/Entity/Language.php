 ...
 * @ORM\Entity(repositoryClass="Cms\Entity\Repository\LanguageRepository")
...
class Language
{
     ...
     * @var string
     *
     * @ORM\Column(name="lang_name", type="string", length=50, nullable=false)
     ...
     * @var string
     *
     * @ORM\Column(name="lang_abbreviation", type="string", length=10, nullable=true)
	 * @Annotation\Filter({"name":"StringTrim"})
     * @Annotation\Validator({"name":"StringLength", "options":{"min":1, "max":30}})
     * @Annotation\Validator({"name":"Regex", "options":{"pattern":"/^[a-zA-Z][a-zA-Z0-9_-]{0,24}$/"}})
     * @Annotation\Attributes({"type":"text"})
